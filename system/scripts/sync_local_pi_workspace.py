...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--pulse-lock-path",
        default="",
        help="Override run-halfhour-pulse mutex path. Defaults to <target-root>/output/state/run-halfhour-pulse.lock.",
    )
    parser.add_argument(
        "--lock-timeout-sec",
        type=float,
...
def main() -> int:
    ...
    pulse_lock_path = (
        ...
        else (target_root / "output" / "state" / "run-halfhour-pulse.lock").resolve()
    )
